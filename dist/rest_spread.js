...
var timesDeFutebolRio = ['Vasco', 'Bota-Fogo', 'Flamengo', 'Fluminense'];

// const timesDeFutebol = timesDeFutebolDeSp.concat(timesDeFutebolRio);
var timesDeFutebol = [].concat(timesDeFutebolDeSp, timesDeFutebolRio);
...
var carroDoSaul = _objectSpread(_objectSpread({}, carroDoBruno), {}, {
  motor: 1.8
});
...
var motorDoCarroDoSaul = carroDoSaul.motor;
var motorDocarroDoBruno = carroDoBruno.motor;
